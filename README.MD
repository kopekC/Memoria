...
This function stops a set of running VLC media player instances basdasdasdas
asdasd asdas asdasr the project is memoria.py, which sets up the schedule for
